...
export const ChatRoom = () => {
  ...
  const joinChat = async () => {
    let config = {
      method: "post",
      url: "https://902c-103-240-204-216.in.ngrok.io/api/v1/chat-room/create",
      headers: {
  ...
  const joinVideo = async () => {
    let config = {
      method: "GET",
      url: "https://902c-103-240-204-216.in.ngrok.io/api/v1/appointment/get?_id=6319da29bc2fe6c9166d4391&&video=true",
      headers: {
        "Content-Type": "application/json",
      },
      data: [],
